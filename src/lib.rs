...
// Pages
use crate::pages::{
    about::About, author::Author, examples::Examples, ffprobe::Ffprobe, home::Home,
    ...
    view! {
        ...
        <Router>
            <nav>
                ...
                <a class="button" href="/hls-manifest-viewer/author">
                    "Author"
                </a>
            ...
            <main>
                <Routes fallback=NotFound>
                    ...
                    <Route path=path!("/hls-manifest-viewer/author") view=Author />
